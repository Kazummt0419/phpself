...
<link rel="stylesheet" type="text/css" href="/css/info_registConfirm.css">
...
<div id="l-wrap">
  ...
  <main id="p-infoRegistConfirm" class="c-marginTop5 c-marginBottom5">
    <section>
      <div id="p-infoRegistConfirm-head">
        <h2 id="p-infoRegistConfirm-head__title">お知らせ登録確認</h2>
      </div>
      <h3 id="p-infoRegistConfirm-form__head" class="c-font__bold">以下の内容で問題ないでしょうか？</h3>
      <table id="p-infoRegistConfirm-form-table">
        <tr>
          <th>タイトル</th>
      ...
      <form class="c-marginTop5" action="info_registComp.php" method="POST">
        ...
        <div class="p-infoRegistConfirm-form-buttonBox c-marginTop2">
          <input type="submit" value="OK" style="cursor:pointer" class="p-infoRegistConfirm-form-buttonBox__button">
        </div>
        <div class="p-infoRegistConfirm-form-buttonBox c-marginTop2">
          <input type="button" value="キャンセル" style="cursor:pointer" onclick="history.back()" class="p-infoRegistConfirm-form-buttonBox__button">
        </div>
      </form>
    </section>
  </main>
